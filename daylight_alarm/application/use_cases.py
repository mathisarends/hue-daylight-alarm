...
from daylight_alarm.domain.value_objects import BrightnessRange, Duration, SoundProfile, TransitionSteps
from daylight_alarm.infrastructure.event_handlers import AlarmAudioHandler


class StartSunriseAlarmUseCase:
    def __init__(self, event_dispatcher: EventDispatcher, audio_handlers: list[AlarmAudioHandler] = None):
